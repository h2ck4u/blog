...
import type { Post, TagFilterItem } from '@/entities/post/model/types';
import type {
  PageObjectResponse,
  ...
  return {
    ...
    slug:
      properties.Slug.type === 'rich_text'
        ...
        : page.id,
    thought:
      'Thought' in properties && properties.Thought.type === 'checkbox'
        ? properties.Thought.checkbox
        : false,
  };
}
...
export const getPublishedPosts = async (
  ...
  return unstable_cache(
    () => fetchPublishedPosts({ tag, sort, pageSize, startCursor, isThought }),
    [`posts-list-${cacheKey}`],
    {
      tags: ['posts'],
      revalidate: 60,
