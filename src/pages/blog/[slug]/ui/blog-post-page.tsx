...
import { getPostBySlug } from '@/shared/lib/notion';
...
import { PostComments as GiscusComments } from '@/features/post-comments';
...
export async function generateMetadata({
  ...
  return {
    title: post.title,
    description: post.description || `${post.title} - ${BLOG_CONFIG.name}`,
    keywords: post.tags,
    authors: [{ name: post.author || BLOG_CONFIG.author.name }],
