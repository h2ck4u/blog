...
import { GetPublishedPostsResponse } from '@/shared/lib/notion';
...
export default function PostList({ postsPromise, isThought }: PostListProps) {
  ...
  const fetchPosts = async ({ pageParam }: { pageParam: string | undefined }) => {
    ...
    if (isThought !== undefined) params.set('isThought', isThought.toString());
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage } = useInfiniteQuery({
    queryKey: ['posts', tag, sort, pageSize, isThought],
    queryFn: fetchPosts,
